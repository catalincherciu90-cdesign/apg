...
app.get('/login', (c) => {
  ...
  return c.html(page({ title: 'Autentificare — APG Garage', user: null, nav: 'public', headExtra: AUTH_STYLE, body: loginBody('', accesError, '') }));
});
...
app.post('/login', async (c) => {
  ...
  return c.html(page({ title: 'Autentificare — APG Garage', user: null, nav: 'public', headExtra: AUTH_STYLE, body: loginBody(error, false, email) }));
});
...
app.get('/register', (c) => {
  if (c.get('user')) return c.redirect('/dashboard');
  return c.html(page({ title: 'Creare cont — APG Garage', user: null, nav: 'public', headExtra: AUTH_STYLE, body: registerBody('', '', {}) }));
});
...
app.post('/register', async (c) => {
  ...
  return c.html(page({ title: 'Creare cont — APG Garage', user: null, nav: 'public', headExtra: AUTH_STYLE, body: registerBody(error, success, vals) }));
});
