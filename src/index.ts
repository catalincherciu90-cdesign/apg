...
app.use('*', async (c, next) => {
  ...
  try {
    ...
    const telBtn = telHref
      ? `<a href="tel:${telHref}" aria-label="Sună acum" class="apg-fab apg-fab-tel">
          <svg viewBox="0 0 24 24" width="26" height="26" fill="#fff"><path d="M6.62 10.79a15.5 15.5 0 0 0 6.59 6.59l2.2-2.2a1 1 0 0 1 1.02-.24c1.12.37 2.33.57 3.57.57a1 1 0 0 1 1 1V20a1 1 0 0 1-1 1A17 17 0 0 1 3 4a1 1 0 0 1 1-1h3.5a1 1 0 0 1 1 1c0 1.24.2 2.45.57 3.57a1 1 0 0 1-.25 1.02l-2.2 2.2z"/></svg>
        </a>`
      : '';
    ...
    const chrome = `<style>
      ...
      .apg-fab-tel{bottom:84px;background:var(--red,#c0392b);display:none;}
      @media(max-width:768px){.apg-fab-tel{display:flex;}}
